/**
 * @fileoverview MentalHealthWellnessSection component
 *
 * Individual industry section that loads dynamically when Mental Health & Wellness
...
export default function MentalHealthWellnessSection({ onClose }) {
  return (
      ...
      >
        ...
        <div>
          ...
          <p className="text-textLight/80 leading-relaxed mb-6">
            ...
            describing how immersive technology can support mental
            health and wellness initiatives, therapy, mindfulness, and
            wellbeing programs.]
          </p>

          <h5 className="text-lg font-bold text-primary mb-4">
            For Healthcare Providers & Wellness Brands
          </h5>
